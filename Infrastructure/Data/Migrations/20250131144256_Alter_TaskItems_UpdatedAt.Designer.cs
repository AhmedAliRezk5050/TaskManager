...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20250131144256_Alter_TaskItems_UpdatedAt")]
    partial class AlterTaskItemsUpdatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.TaskItem", b =>
                {
                    b.HasOne("Infrastructure.Data.ApplicationUser", "CreatedBy")
                        .WithMany("CreatedTaskItems")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Infrastructure.Data.ApplicationUser", "UpdatedBy")
